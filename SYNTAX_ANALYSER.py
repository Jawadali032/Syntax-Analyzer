...
def SyntaxAnalyzer():
    if (START()):
        ...
        print("SYNTAX ERROR -->" , {tokens[index].classPart} , "  at  " , {tokens[index].lineNumber})

def Class_Mod():
    global index
    if(tokens[index].classPart=="sealed"):
        index+=1
        return True
    elif(tokens[index].classPart=="abstract"):
        index+=1
        return True
...
def ACCESS_MODIFIER():
    ...
    if (tokens[index].value == "protected"):
        index += 1
        return True
    elif(tokens[index].value == "private"):
        index += 1
        return True
    elif(tokens[index].value == "public"):
        index += 1
        return True
    return False
